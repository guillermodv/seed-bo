...
const generalChart = general => {
    ...
    return {
        ...
        datasets: [{
            ...
            borderWidth: 1,
            data,
            ...ChartColours(general._id.state)
        }]
    };
};
...
const pollstersChart = pollster => {
    ...
    return {
        ...
        datasets: [{
            ...
            borderWidth: 1,
            data,
            ...ChartColours(pollster._id.state)
        }]
    };
};
...
const dwellings = dwelling => {
    ...
    return {
        ...
        datasets: [{
            ...
            borderWidth: 1,
            data,
            ...ChartColours(dwelling._id.state)
        }]
    };
};
...
const households = household => {
    ...
    return {
        ...
        datasets: [{
            ...
            borderWidth: 1,
            data,
            ...ChartColours(household._id.state)
        }]
    };
};
