...
const reportsTabs = {
    PREVIEW: 'preview',
    BLOCKS_AND_SIDES: 'blocksAndSides',
    DWELLINGS: 'dwellings'
};

const dwellingReportTypes = [
    {value: 'type', label: 'Viviendas Por tipo'},
    {value: 'noEligible', label: 'Viviendas No elegibles'},
    {value: 'withoutNumberOrDoor', label: 'Viviendas sin N° Catastral o de Puerta'}
];
...
const areaStateTranslate = [
    {_id: 1, description: 'Abierta'},
    {_id: 2, description: 'En Campo'},
    {_id: 3, description: 'Cerrada'},
    {_id: 4, description: 'En supervisión'},
...
const messages = {
    ...
    INVALID_POSTAL_CODE: 'No existe código postal o es menor/igual a 0.',
